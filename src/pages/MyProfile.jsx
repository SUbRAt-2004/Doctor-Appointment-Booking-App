...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email:"1QlMl@example.com",
    phone:"+91-90403-42617",
    address: {
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
      ...
      <div>
            ...
            <div className='mt-10'>
                ...
                {isEdit
                    ? <button onClick={() => setIsEdit(false)} className='border border-[#5f6FFF] px-8 py-2 rounded-full hover:bg-[#5f6FFF] hover:text-white transition-all'>Save information</button>
